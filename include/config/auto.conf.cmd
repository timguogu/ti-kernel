deps_config := \
	...
	drivers/staging/media/wave5/Kconfig \
...
ifneq "$(KERNELVERSION)" "5.10.100"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "arm-none-linux-gnueabihf-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "arm-none-linux-gnueabihf-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm"
include/config/auto.conf: FORCE
endif
ifneq "$(KBUILD_DEFCONFIG)" "multi_v7_defconfig"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "arm-none-linux-gnueabihf-gcc (GNU Toolchain for the A-profile Architecture 9.2-2019.12 (arm-9.10)) 9.2.1 20191025"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "arm-none-linux-gnueabihf-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "arm-none-linux-gnueabihf-objcopy"
include/config/auto.conf: FORCE
endif
